...
const ScheduledPage: React.FC = () => {
  ...
  const data = isSearching ? searchData : scheduledData;
  const isLoading = isSearching ? isLoadingSearch : isLoadingScheduled;
        ...
        {isLoading ? (
          ...
          <div className="p-8 h-full">
            <EmptyState 
              ...
              description={isSearching ? "No emails match your search." : "You don't have any emails scheduled for the future."}
              action={!isSearching && (
